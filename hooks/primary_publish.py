...
class PrimaryPublishHook(Hook):
    ...
    def execute(self, task, work_template, comment, thumbnail_path, sg_task, progress_cb, **kwargs):
        ...
        if engine_name == "tk-maya":
            ...
            return self._do_cinema_publish(
    ...
    def _do_cinema_publish(self, task, work_template, comment, thumbnail_path,
                           sg_task, progress_cb):
        """
        Publish the main Maya scene
        """
        ...
        progress_cb(0.0, "Finding scene dependencies", task)
        dependencies = self._cinema_find_additional_scene_dependencies()
        ...
        c4d.documents.SaveDocument(
            doc, publish_path, c4d.SAVEDOCUMENTFLAGS_0, c4d.FORMAT_C4DEXPORT)
        ...
        # work out publish name:
        publish_name = self._get_publish_name(publish_path, publish_template,
                                              fields)
    ...
    def _cinema_find_additional_scene_dependencies(self):
        """
        Find additional dependencies from the scene
        """
        # initial implementation does nothing!
